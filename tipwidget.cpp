...
void tipWidget::installWindow()
{
    ...
    upBtn->setStyleSheet("background-color:rgba(89,89,249,100);border:0");
    downBtn->setStyleSheet("background-color:rgba(89,89,249,100);border:0");
    leftBtn->setStyleSheet("background-color:rgba(89,89,249,100);border:0");
    rightBtn->setStyleSheet("background-color:rgba(89,89,249,100);border:0");
    ...
    moveLabel1->setStyleSheet("background-color:rgba(255,255,255,0);color:rgba(255,255,255,150);font-weight:bold;font-size:13px");

    QLabel *tiplabel=new QLabel(tr("操作提示!"));
    tiplabel->setStyleSheet("background-color:rgba(255,255,255,0);color:rgba(255,255,255,150);font-weight:bold;font-size:18px");
    QHBoxLayout *layout0=new QHBoxLayout;
    layout0->addWidget(tiplabel);
    ...
    wBtn->setStyleSheet("background-color:rgba(89,89,249,100);border:0");
    sBtn->setStyleSheet("background-color:rgba(89,89,249,100);border:0");
    aBtn->setStyleSheet("background-color:rgba(89,89,249,100);border:0");
    dBtn->setStyleSheet("background-color:rgba(89,89,249,100);border:0");
    ...
    moveLabel2->setStyleSheet("background-color:rgba(255,255,255,0);color:rgba(255,255,255,150);font-weight:bold;font-size:13px");
    ...
    spaceLabel->setStyleSheet("background-color:rgba(255,255,255,0);color:rgba(255,255,255,150);font-weight:bold;font-size:13px");
    speedButton1->setStyleSheet("background-color:rgba(89,89,249,100);border:0");
    speedButton2->setStyleSheet("background-color:rgba(89,89,249,100);border:0");
    ...
    pauseLabel->setStyleSheet("background-color:rgba(255,255,255,0);color:rgba(255,255,255,150);font-weight:bold;font-size:13px");
    ...
    useLabel->setStyleSheet("background-color:rgba(255,255,255,0);color:rgba(255,255,255,150);font-weight:bold;font-size:13px");
    ...
    pauseButton->setStyleSheet("background-color:rgba(89,89,249,100);border:0");
    useButton->setStyleSheet("background-color:rgba(89,89,249,100);border:0");
