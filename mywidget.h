...
private:
    ...
    QGraphicsWidget *button1,*button2,*button3,*button4,*button,*button_1;
    ...
    myPushButton *loginBtn,*goRegisterBtn,*registerBtn,*goLoginBtn,*beginBtn,*setBtn;
    ...
    QCursor *cursor;
    myLabel *gifLabel;
    QSlider *slide1,*slide2;                                               // 背景音量、音效音量
    QWidget *SET;
};
#endif // MYWIDGET_H
